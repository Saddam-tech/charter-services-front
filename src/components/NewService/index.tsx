...
const NewService = ({ reload, close }: { reload: () => void; close: () => void }) => {
    ...
    async function handleSubmit() {
        try {
            ...
            setLoader(true);
            await provider.post(EPS.NEW_SERVICE, formData);
            setLoader(false);
            addToast(MESSAGES.UPLOAD_COMPLETE('Service'), {
                appearance: 'success',
                autoDismiss: true,
            });
            reload();
                ...
                <ThemeProvider theme={theme}>
                    ...
                    >
                        <div className="image-input-wrap">
                            <label htmlFor="bannerInput">Select Service Image</label>
